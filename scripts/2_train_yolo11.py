...
def train_model(data_yaml_path, epochs=50, batch_size=16, imgsz=640, model_type='yolo11n.pt'):
    """
    Trains a YOLO11 model for crowd detection.
    ...
    Args:
        ...
        model_type: Which YOLO11 model to start with ('yolo11n.pt' or 'yolo11s.pt').
    """
...
if __name__ == "__main__":
    ...
    # We use yolo11n (nano) as requested for lightweight detection
    train_model(yaml_path, epochs=30, batch_size=16, model_type='yolo11n.pt')
