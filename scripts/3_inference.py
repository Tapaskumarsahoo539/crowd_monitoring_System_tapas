...
def monitor_crowd(source, model_path, output_dir, threshold=9):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="yolov8n.pt", help="Path to trained model weights")
    ...
    if not os.path.exists(model_path):
        # Fallback to local execution using default yolov8n downloads
        model_path = args.model
    
    monitor_crowd(args.source, model_path, out_dir, args.threshold)
